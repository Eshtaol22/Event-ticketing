...
------------------------------------------------inserting data------------------------------------------------------------
--Table 1
insert into  Users(users_id,first_name,middle_name,last_name,email,phone,Address_User)
values(01,"Gatoch","Tamene","Aschalew","gatochtamene@gmail.com",0911232425,"Addis Ababa"),
(02,'Abraham','Gebre','Tamene','abrahamgebre@gmail.com',0911232425,'Adama'), 
(03,'Mbratu','Mekebib','Sisay','mebratumekebib@gmail.com',0911090807,'Mojio'),
(04,'Solomon','Aragaw','Belachew','solomonaragaw@gmail.com',0911899008,'Hawassa'),
(05,'Asefaw','Abate','Kenamen','asefawabate@gmail.com',0918765434,'Adama'),
(06,'Abebe','Kebede','Yoseph','abebe.kebede@mail.com',0912345678, 'Afar'),
(07,'Meskerem','Mekonnen','Beka', 'meskerem.mekonnen@gmail.com', 0987654321,'Diredewa'),
(08,'Mulugeta','Haile','Henok', 'mulugeta.haile@gmail.com', 090055555,'Asem'),
(09,'Sara','Alemu','Tesfaye', 'sara.alemu@gmail.com', 099909999,'Bale'),
(10,'Temesgen','Hailu','Berhanu', 'temesgen.hailu@gmail.com',092202222,'Wenchi'),
(11,'Genet','Assefa','Tadesse', 'genet.assefa@gmail.com',0977007777,'Debrezeyt'),
(12,'Mekonnen','Tadesse','Yonas', 'mekonnen.tadesse@gmail.com', 0966966666,'Debrebrhan'),
(13,'Yeshiwork','Tsegaye','Gebre','yeshiwork.tsegaye@gmail.com',0944455444,'Wello');
...
values(0001,'u01','3000','2023-09-01'),
(0002,'u02','3000','2023-09-02'),
(0003,'u03','3000','2023-09-03'),
(0004,'u04','3000','2023-09-04'),
(0005,'u05','3000','2023-09-05');
...
FROM reservation
ORDER BY date_reservation ASC, time_reservation DESC;
----------------------------------------------------------
...
UPDATE ticketing SET status_ticketing = 'Available' WHERE ticket_id = 't01';
UPDATE seat SET seat_number = seat_number - 1 WHERE seat_id = (SELECT seat_id FROM ticketing WHERE ticket_id = 't01');

-- Step 3: Debit Buyer
UPDATE Users SET phone = phone - (SELECT price FROM ticketing WHERE ticket_id = 't01') WHERE Users_id = '01';

-- Step 4: Credit Seller
UPDATE Users SET phone = phone + (SELECT price FROM ticketing WHERE ticket_id = 't01') WHERE Users_id = (SELECT users_id FROM reservation WHERE ticket_id = 't01');

-- Step 5: Credit Taxer
SET @taxAmount := (SELECT price * 0.1 FROM ticketing WHERE ticket_id = 't01');
UPDATE Users 
SET phone = phone + @taxAmount 
WHERE Users_id = 'taxer';
...
CREATE USER 'DBadmin_username' IDENTIFIED BY 'dbadmin456';
use Ticketing_System;
GRANT ALL PRIVILEGES ON ticketing TO 'DBadmin_username';
...
CREATE USER 'EventManager_username' IDENTIFIED BY 'EventMg123';
CREATE USER 'tickerseller' IDENTIFIED BY 'tecket123';
GRANT SELECT, INSERT, UPDATE, DELETE ON ticketing_event TO 'tickerseller';

GRANT SELECT, INSERT, UPDATE, DELETE ON venue TO 'tickerseller';
